...
const Footer = () => {
    return (
        <div className='mt-5'>
            <footer className="footer footer-center p-10 bg-red-300 text-dark">
            <div>
            <div className="w-32 m-3"><img className='rounded-full' src={logo} alt=""/></div>
                <p className="font-bold text-xl">
                The Brainy Hub <br/>Providing reliable sources of learning since 1992
                </p> 
